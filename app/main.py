...
VC_channel = int(os.environ.get("Voice_Channel"))
Text_channel = int(os.environ.get("Text_Channel"))

LINE_TOKENS = os.environ.get("LINE_TOKENS").split(",")

data_json_path = "app/data.json"
