...
VC_channel = int(os.environ.get("Cu_Voice_Channel"))
Text_channel = int(os.environ.get("Cu_Text_Channel"))

data_json_path = "app/curry_bot/data.json"
...
def cu_main():
    ...
    async def on_message(message):
        ...
        if message.content.startswith('$curry'):
            embed = discord.Embed(
                title="Curry Server BOT",
                description="I am Curry Server BOT.\nI love Curry and Rice very much.",
                color=0xbe7a11
            )
